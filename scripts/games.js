...
const GAMES_DATA = {
	...
	"games": {
		...
		"monad": {
			"name": "Monad",
			"time": "30 min",
			"desc": "Sid Sackson's 1969 classic. Trade and leap your way from Commons up to Monad discs. First to collect enough wins.",
			"players": [2, 4],
			"ideal": [3, 4],
			"tags": [TAGS.CARD, TAGS.STRATEGY, TAGS.CLASSIC]
		},
		"canvas": {
			"name": "Canvas",
			"time": "30 min",
		...
		"1961": {
			"name": "1961",
			"time": "15 min",
			"desc": "Bolster your nation, spy on enemies, and fly to the moon. Cold War card game in 15 minutes.",
			"players": [2, 6],
			"ideal": [3, 5],
		...
		"cafe_chaos": {
			"name": "Cafe Chaos",
			"time": "20 min",
			"desc": "TheOdd1sOut's food fight card game. Choose Grab, Throw, or Duck each round — least splat wins.",
			"players": [3, 6],
			"ideal": [4, 6],
			"tags": [TAGS.CARD, TAGS.PARTY, TAGS.FAMILY]
		},
		"cant_catch_harry": {
			...
			"time": "15 min",
			"desc": "TheOdd1sOut's take on Spoons. Race to collect 4-of-a-kind, then grab a moth before everyone else does.",
			"players": [2, 6],
			"ideal": [4, 6],
			"tags": [TAGS.CARD, TAGS.PARTY, TAGS.FAMILY]
		},
		...
		"yamma": {
			"name": "Yamma",
			"time": "20 min",
			"desc": "Connect Four meets 3D geometry. Place cubes on a rotating board and make four-in-a-row from any angle.",
			"players": [2, 2],
			"ideal": [2, 2],
			"tags": [TAGS.TWO_PLAYER, TAGS.STRATEGY]
		},
		"big_sur": {
			"name": "Big Sur",
			"time": "30 min",
			"desc": "Build a stretch of Highway 1 by drafting cards as either road sections or resources. Score for scenic runs.",
			"players": [2, 4],
			"ideal": [2, 4],
			"tags": [TAGS.CARD, TAGS.ENGINE, TAGS.STRATEGY]
		},
		"one_night_werewolf": {
		...
		"flip_7": {
			"name": "Flip 7",
			"time": "10 min",
			"desc": "Flip numbered cards and bank your score — or keep hitting and risk busting. Get 7 unique numbers for a bonus.",
			"players": [2, 6],
			"ideal": [3, 5],
			"tags": [TAGS.CARD, TAGS.PARTY, TAGS.FAMILY]
		},
		...
		"monkey_palace": {
			"name": "Monkey Palace",
			"time": "45 min",
			"desc": "Rebuild a palace for monkeys using actual LEGO bricks. Spend monkey credits on cards to grow your brick income.",
			"players": [2, 4],
			"ideal": [3, 4],
			"tags": [TAGS.ENGINE, TAGS.STRATEGY, TAGS.FAMILY]
		},
		"splendor": {
			"name": "Splendor",
			"time": "30 min",
		...
		"priorities": {
			"name": "Priorities",
			"time": "20 min",
			"desc": "Rank five everyday things from love to loathe. Everyone cooperates to guess your order before the game spells PRIORITIES first.",
			"players": [3, 8],
			"ideal": [4, 7],
			"tags": [TAGS.PARTY, TAGS.COOP]
		},
		"coup": {
			"name": "Coup",
			"time": "15 min",
		...
		"go_f_yourself": {
			...
			"time": "20 min",
			"desc": "Adult Go Fish. Ask opponents for embarrassing cards to complete sets of four. No? Go f**k yourself.",
			"players": [3, 6],
			"ideal": [4, 6],
			"tags": [TAGS.PARTY, TAGS.CARD]
		},
		"power_hungry_pets": {
			...
			"time": "15 min",
			"desc": "Love Letter reimagined by Exploding Kittens. Hold one card, draw one, decide which to keep — highest card wins the round.",
			"players": [2, 6],
			"ideal": [3, 5],
			"tags": [TAGS.CARD, TAGS.DEDUCTION, TAGS.PARTY]
		},
		"happy_salmon": {
			"name": "Happy Salmon",
			"time": "5 min",
